  ...
  return (
    <>
      <div
        ...
        id="home"
      >
        <div className=" h-full w-96 flex flex-col items-center mt-96">
        ...
        <div className=" w-2/3 h-80 flex justify-center items-center ml-80 mr-80 p-2">
          ...
          <div className="w-24 h-full m-2 flex flex-col flex-grow m-3 mr-16">
            <div
              className=" h-24 w-[280px] flex flex-grow m-2 ml-0 relative rounded-lg overflow-hidden cursor-pointer transform transition duration-300 hover:scale-105 hover:shadow-lg hover:brightness-90 active:scale-95"
            ...
            <div className="flex h-14 m-2 ml-24 items-center p-2 justify-center">
          ...
          >
            ...
            <div className="flex h-14 m-2 ml-40 items-center p-2 justify-center">
              <span className="text-3xl text-orange-500 bg-orange-200/70 mr-1 px-4 py-1 rounded-md">
                C
              </span>
              <span className="text-3xl text-orange-500 bg-orange-200/70 mr-1 px-4 py-1 rounded-md">
